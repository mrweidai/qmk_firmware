...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  MO(_FN2),KC_SPC,  KC_SPC,  MO(_FN2),_______,_______, MO(_FN3),KC_RCTL
  ),

  [_FN1] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    KC_TAB,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL, KC_BSLS, \
    _______, KC_HOME, KC_PGUP, KC_UP,   KC_PGDN, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_MSTP, _______, _______,\
    _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  _______, KC_VOLD, KC_VOLU, KC_MUTE, _______, _______, _______, _______, \
    _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______
  ),

  [_FN2] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    KC_GESC, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,  KC_F6,  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, KC_GRV, \
    _______, _______, _______, KC_MS_BTN1, KC_MS_UP, KC_MS_BTN2, _______, _______, KC_PGUP, KC_UP,   KC_PGDN, _______, _______,\
    _______, _______,KC_MS_LEFT,KC_MS_DOWN,KC_MS_RIGHT, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, \
    _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______
  ),
